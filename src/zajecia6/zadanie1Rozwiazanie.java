...
public class zadanie1Rozwiazanie {
...
//        h.! Skorzystaj z klasy java.util.Random
            ...
            //bierzemy po kolei kazda nasza liczbe i porownujemy z tymi wylosowanymi czyli 6x6- 36 porownan
            // dlatego dalej 2 petle- iteruja po 1 i 2giej tablicy
        ...
        private static void losujUnikalneLiczby(int[] liczbyWylosowane, int zakres) {
            Random r = new Random();
            int wylosowanaLiczba = 0;  // musi byc podana jakas wartosc poczatkowa
        ...
        private static void drukujTablice(String tytul, int[] tablica) {
            System.out.println(tytul + " | " + Arrays.toString(tablica) + "\n");  //pomaga wypisac wszystkie elementy tablicy Array.toString
        }
        ...
        public static void pobierzUnikalnaLiczbeOdUzytkownika(Scanner scanner, int[] dowolnaTablica, int index) {
            ...
            while (!czyLiczbaJestUnikalna(dowolnaTablica, liczbaOdUZytkownika)) { // !-negacja
